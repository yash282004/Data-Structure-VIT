...
To write a C++ program to accept a weighted graph from the user, store it using an adjacency list, sort edges, and apply Kruskal’s Algorithm to find the Minimum Spanning Tree (MST).

## Problem Statement:

- Design a C++ program that:

1. Accepts a weighted undirected graph

2. Stores it using an Adjacency List

3. all edges and sorts them

4. Uses Kruskal’s Algorithm (Disjoint Set / Union-Find)

5. Prints the final Minimum Spanning Tree and minimum cost
...
- Extract all edges from adjacency list into an edge list.

5. Step 5:

- Sort all edges using increasing weight.

- Step 6:

- Use Union-Find to detect cycles:

- If two vertices belong to different sets → include edge

- Else skip (cycle formed)
...
- Print MST edges and total minimum cost.
...
- Edges stored separately for sorting
- Kruskal’s algorithm chooses the smallest edges first
